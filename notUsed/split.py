...
datadir_normal = r"E:\THUCNews\02science\02science"
...
trainDir = "E:/train/normal"  # （将训练集放在这个文件夹下）
if not os.path.exists(trainDir):
    os.mkdir(trainDir)

validDir = 'E:/val/normal'  # （将验证集放在这个文件夹下）
if not os.path.exists(validDir):
    os.mkdir(validDir)

testDir = 'E:/test/normal'  # （将测试集放在这个文件夹下）
